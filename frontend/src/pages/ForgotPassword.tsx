      ...
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl border border-gray-200 p-8 relative z-10">
        ...
        {success ? (
          <div className="space-y-4">
            ...
            {success.token && (
              <div className="p-4 bg-gray-50 border border-gray-200 rounded-lg text-sm text-gray-700">
                ...
                <Link
                  to={`/reset-password?email=${encodeURIComponent(email)}&token=${encodeURIComponent(success.token)}`}
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <Link to="/login" className="block text-center text-gray-600 hover:text-gray-900 text-sm">
              Back to login
            </Link>
          </form>
        )}
